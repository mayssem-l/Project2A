...
Employees::Employees(int id, QString nom, QString prenom, QString gender, QDate date, QString adresse, QString email, QString tel, QString poste, QString mdp, QString Answ1, QString Answ2) {
  Id_E = id;
  Nom_E = nom;
  Prenom_E = prenom;
  Sexe_E = gender;
...
bool Employees::ajouter() {
  ...
  query.prepare("INSERT INTO MAYSSEM.EMPLOYEES VALUES(:id_emp,:nom_emp,:prenom_emp,TO_DATE(:date_nais,'yyyy-MM-dd'),:add_emp,:email_emp,:tel_emp,:poste_emp,:mdp_emp,:sexe_emp,:Answ1_emp,:Answ2_emp);");
...
bool Employees::modifier() {
  ...
  query.prepare("UPDATE MAYSSEM.EMPLOYEES SET ID_E=:id_emp,NOM_E=:nom_emp,PRENOM_E=:prenom_emp,DATE_NAISSANCE=TO_DATE(:date_nais,'yyyy-MM-dd'),ADRESSE_E=:add_emp,EMAIL_E=:email_emp,TEL_E=:tel_emp,POSTE_E=:poste_emp,MDP_E=:mdp_emp,SEXE_E=:sexe_emp,:Answ1_emp,:Answ2_emp where ID_E= :id_emp");
  query.bindValue(":id_emp", Id_E);
  query.bindValue(":nom_emp", Nom_E);
  query.bindValue(":prenom_emp", Prenom_E);
  query.bindValue(":sexe_emp", Sexe_E);
