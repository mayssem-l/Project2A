...
bool Client::ajouter() {
    QSqlQuery query;
    query.prepare("INSERT INTO CLIENTS (ID_C, NOM_C, FIRST_NAME_C, AGE_C, ADRESSE_C, REGION_C, E_MAIL_C, TEL_C) "
...
bool Client::modifier() {
    QSqlQuery query;
    query.prepare("UPDATE CLIENTS SET NOM_C = :name, FIRST_NAME_C = :first_name, AGE_C = TO_DATE(:age, 'yyyy-MM-dd'), "
